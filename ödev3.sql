...
'A' karakteri ile başlayıp 'a' karakteri ile sonlananlar*/

SELECT country FROM country 
WHERE country LIKE 'A%a';

/*Country tablosunda bulunan country sütunundaki ülke isimlerinden
en az 6 karakterden oluşan ve sonu 'n' karakteri ile sonlananlar*/

SELECT country FROM country 
WHERE country LIKE '%_____n';
/*Film tablosunda bulunan title sütunundaki film isimlerinden en az
4 adet büyük ya da küçük harf farketmesizin 'T' karakteri içeren film isimleri*/
